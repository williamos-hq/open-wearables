...
The checked-in manifest is the source of truth. It rejects arbitrary bridge
...
| `dailies` | `get_stats`, `get_user_summary` | Daily; one local date | Profile date | Empty object |
...
| `404` | Open Wearables user or Garmin activity does not exist | Reconcile identity or import activity first |
