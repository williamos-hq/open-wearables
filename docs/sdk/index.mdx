...
Unlike official cloud-based providers such as Polar and Suunto, on-device health stores require a **push-based model** where data is sent from the user's device to your backend. Garmin uses the private bridge import in this fork.
